...
const SearchRoomHome: React.FC<SearchRoomHomeProps> = () => {
    ...
    const [numberOfGuest, setNumberOfGuest] = useState<string>('single');
            ...
            <div className="flex flex-col gap-1 items-center my-1 justify-center">
                ...
                <div className="relative w-full  ">
                    ...
                    <select
                        ...
                        className=" w-full py-2 pl-2 text-sm text-gray-600 bg-white  rounded-lg  outline-none appearance-none focus:ring-offset-2 focus:ring-indigo-600 focus:ring-2"
                    >
