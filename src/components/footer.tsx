        ...
        < footer className="bg-white" >
            <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        <div className="flex justify-center items-center gap-3 text-gray_800 font-bold">
                            <img src="/assets/dbooking_logo.svg" alt="logo da empresa dbooking" className='w-14 h-14' />
                            <span>DBooking</span>
                        </div>
                        ...
                        <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
                            <li>
                                <a
                                    ...
                                    rel="noreferrer"
                                    target="_blank"
                                    className="text-green_500 transition hover:green_500/75"
                                >
                ...
                <div className="mt-12 border-t border-gray-100 pt-6">
                    <div className="text-center sm:flex sm:justify-between sm:text-left">
                        ...
                        <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">&copy; 2024 dbooking - @brunodias.dev</p>
                    </div>
                </div>
            </div>
        </footer >
